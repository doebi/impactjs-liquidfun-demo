...
MyGame = ig.Box2DGame.extend({
	...
	init: function() {
        ...
        ig.system.particleSystem = ig.game.spawnEntity( ParticleSystem, 1).system;
...
var scale = (window.innerWidth < 640) ? 8 : 4;
...
ig.main('#canvas', MyGame, 60, width/16, height/16, scale);
